...
int lancer_de(int* val_de1, int* val_de2)
{
    // variables
    int somme_de;
    char chaine_de1[16] = "Vous avez fait";
    char chaine_de2[3] = "et";
    char chaine_de3[15] = "! Avancez de";
    char chaine_de4[8] = "cases\n";
    srand(time(NULL)); // initialisation générateur de nombres
    // On demande de lancer les dés

    // génération de deux dés
    *val_de1 = 3;//(rand() % (MAX_DE-MIN_DE + 1) + MIN_DE);
    *val_de2 = 2;//(rand() % (MAX_DE-MIN_DE + 1) + MIN_DE);
