...
int tour_joueur( int x, int repere[], t_joueur joueur_i[], int nombre_joueurs, int id_joueur, t_carte cartes_terrain[][3], int id_carte[], int tab_cartes_c[], int loto, int card_chance, int card_commu, int sauvegarde_position[], int banque_de_carte[], int tour_prison[])
{
    int longueur;
    int longueur_2;
    int de1, de2;
    ...
    while ((nb_lancer == 0) || (de1 == de2))
    {
        ...
        if (key == TOUCHE_ESPACE) // On entre 32 en constante, correspondant à ESPACE
        {
            ...
            else if (nb_lancer < 3 && joueur_i[id_joueur].prison == false)
            {
                ...
                case 5:
                    banquechance(joueur_i, x, nombre_joueurs, banque_de_carte, loto, card_chance);
                    usleep(3000);
                    break;
                ...
                case 12:
                    ...
                    banquecommu(joueur_i, x, nombre_joueurs, banque_de_carte, loto, card_commu);
                    usleep(3000);
